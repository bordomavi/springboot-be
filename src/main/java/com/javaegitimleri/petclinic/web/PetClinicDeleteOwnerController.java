...
public class PetClinicDeleteOwnerController {
	...
	public String handleFormSubmit(@PathVariable Long id, RedirectAttributes redirectAttiributes) {
		
		petClinicService.deleteOwner(id);
		redirectAttiributes.addFlashAttribute("message", "Owner deleted with id : "+id);
