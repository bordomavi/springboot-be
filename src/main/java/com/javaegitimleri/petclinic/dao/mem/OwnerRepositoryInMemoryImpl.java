...
public class OwnerRepositoryInMemoryImpl implements OwnerRepository {
	...
	owner1.setId(1L);
	owner1.setFirstName("Hümeyra");
	owner1.setLastName("Sevindik");
	
	Owner owner2 = new Owner();
	owner2.setId(2L);
	owner2.setFirstName("Salim");
	...
	owner4.setId(4L);
	owner4.setFirstName("Aslı");
	owner4.setLastName("Yücel");
	...
	public List<Owner> findByLastName(String lastName) {
		return new ArrayList<>(ownersMap.values().stream().filter(o->o.getLastName().equals(lastName)).collect(Collectors.toList()));
	}
