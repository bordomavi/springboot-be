...
public class PetClinicEditOwnerController {
	...
	public String handleFormSubmit(@ModelAttribute @Valid Owner owner, BindingResult bindigResult, RedirectAttributes redirectAttiributes) {
		if(bindigResult.hasErrors()) {
			return "editOwner";
		}
		petClinicService.updateOwner(owner);
		redirectAttiributes.addFlashAttribute("message", "Owner updated with id : "+owner.getId());
